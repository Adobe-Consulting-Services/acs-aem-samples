 ...
 *  which are similar yet sufficiently different from the CQ Workflow APIs.
 *
 * Note the CQ and GraniteWorkflow APIs are NOT interchangeable, and do not have the same methods available to them.
 *
 * This implementation using the Granite Workflow APIs is considered the more modern approach.
 *
 ...
 */
@Component(
        label = "ACS AEM Samples - AEM Granite Workflow Process",
        description = "ACS AEM Samples - Sample Granite Workflow Process implementation"
)
@Properties({
        @Property(
                name = Constants.SERVICE_DESCRIPTION,
                value = "Sample Granite Workflow Process implementation.",
